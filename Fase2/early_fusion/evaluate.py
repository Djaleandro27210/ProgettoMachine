"""
Evaluation module for Phase 2 Early Fusion (3-modal model).
...
and confusion matrix. Results are printed to console and saved to output_fase2_early.txt.
"""
...
OUTPUT_FILENAME = "output_fase2_early.txt"
...
def load_model(model_path: str, device: torch.device) -> MultimodalEarlyFusionCNN:
...
def format_report(metrics: Dict) -> str:
    ...
    report_text = f"""==================================================
EVALUATION RESULTS - PHASE 2 EARLY FUSION
==================================================
...
def evaluate_model() -> None:
    ...
    # Load model
    model = load_model(MODEL_SAVE_PATH_FASE2, device)
