"""
orchestrator_FASE2_late.py
Sequential orchestrator for Phase 2 (Late Fusion).
...
def run_pipeline() -> None:
    print("[INFO] Initializing Phase 2 Pipeline (Late Fusion)...\n")
    ...
    print("\n[INFO] Phase 2 Pipeline (Late Fusion) completed successfully.")
