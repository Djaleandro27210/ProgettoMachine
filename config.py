...
# The "learning rate": how quickly the network changes its mind (too high = unstable, too low = never learns)
LEARNING_RATE = 0.0001

# How many times the network will see the ENTIRE dataset
EPOCHS = 80
